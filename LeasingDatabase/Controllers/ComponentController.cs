...
namespace LeasingDatabase.Controllers
{
    ...
    public class ComponentController : Controller
    {
        ...
        public ActionResult BillingPopUp(int Id)
		{
            ...
            Component comp = comps.Where(n => n.Type.Name != "Monitor").SingleOrDefault();
            ...
            if (comp != null)
            {
                ...
                ViewBag.IGFInsuranceRate1 = Core.Billing.GetIGFInsuranceRate(comp.Id);
                ...
                if (count > 1)
                {
                    ...
                    ViewBag.IGFInsuranceRate2 = Core.Billing.GetIGFInsuranceRate(mon1.Id);
                ...
                if (count > 2)
                {
                    ...
                    ViewBag.IGFInsuranceRate3 = Core.Billing.GetIGFInsuranceRate(mon2.Id);
            ...
            else
            {
                if (count > 0)
                {
                    ...
                    ViewBag.InsuranceRate1 = Core.Billing.CalculateSecondaryChargeRate(mon1.Id, "Insurance");
                    ViewBag.WarrantyRate1 = Core.Billing.CalculateSecondaryChargeRate(mon1.Id, "Warranty");
                    ViewBag.ShippingRate1 = Core.Billing.CalculateSecondaryChargeRate(mon1.Id, "Shipping");
                    ViewBag.IGFInsuranceRate1 = Core.Billing.GetIGFInsuranceRate(mon1.Id);
                ...
                if (count > 1)
                {
                    ...
                    ViewBag.InsuranceRate2 = Core.Billing.CalculateSecondaryChargeRate(mon2.Id, "Insurance");
                    ViewBag.WarrantyRate2 = Core.Billing.CalculateSecondaryChargeRate(mon2.Id, "Warranty");
                    ViewBag.ShippingRate2 = Core.Billing.CalculateSecondaryChargeRate(mon2.Id, "Shipping");
                    ViewBag.IGFInsuranceRate2 = Core.Billing.GetIGFInsuranceRate(mon2.Id);
