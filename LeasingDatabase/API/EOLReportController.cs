    ...
    public class EOLReportController : ApiController
    {
        ...
        public HttpResponseMessage Get(DateTime date)
        {
            ...
            for (int i = 0; i < models.Count(); i++)
            {
                ...
                ws1.Cells[RowIndex, 2].Value = model.LeaseTag;
                ws1.Cells[RowIndex, 3].Value = model.Term;
                ws1.Cells[RowIndex, 4].Value = model.MonthlyCharge;
                ws1.Cells[RowIndex, 5].Value = model.SR;
                ws1.Cells[RowIndex, 6].Value = model.SerialNumber;
                ws1.Cells[RowIndex, 7].Value = model.Type;
                ws1.Cells[RowIndex, 8].Value = model.Make;
                ws1.Cells[RowIndex, 9].Value = model.Model.ToString();
                ws1.Cells[RowIndex, 10].Value = model.DepartmentName;
                ws1.Cells[RowIndex, 11].Value = model.FOP;
                ws1.Cells[RowIndex, 12].Value = model.RateLevel;
                ws1.Cells[RowIndex, 13].Value = model.StatementName;
